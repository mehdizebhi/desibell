...
public class SMSHttpUtilManager {
    ...
    public Mono<String> requestHttpGet(String baseUrl, String url, Map<String, Object> bodyMap) {
        RequestBodySpec bodySpec = this.httpGetMethod(baseUrl, url);
    ...
    public Mono<String> requestHttpPost(String baseUrl, String url, Map<String, Object> bodyMap) {
        RequestBodySpec bodySpec = this.httpPostMethod(baseUrl, url);
        String bodyRow = new Gson().toJson(bodyMap);
    RequestHeadersSpec<?> headersSpec = bodySpec.bodyValue(bodyRow);
        ResponseSpec responseSpec = headersSpec
                .accept(MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML)
